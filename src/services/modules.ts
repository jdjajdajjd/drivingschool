...
export const MODULE_CATALOG: Module[] = [
  ...
  },
  {
    ...
    category: 'notifications',
    description: 'Уведомления для сотрудников школы о новых записях, отменах и переносах.',
    priceType: 'monthly',
    monthlyPrice: 199,
    icon: 'Send',
    features: ['Новые записи', 'Отмены и переносы', 'Быстрые уведомления сотрудникам школы'],
    isRecommended: true,
  },
  {
    id: 'branding',
  ...
  },
  {
    ...
    name: 'Теория',
    category: 'management',
    description: 'Билеты, темы и зачеты для ученика. Дополнение появится позже и пока не подключается.',
    priceType: 'monthly',
    monthlyPrice: 0,
    usageNote: 'Скоро',
    icon: 'BookOpen',
  ...
  },
  {
    ...
    category: 'analytics',
    description: 'Загрузка инструкторов, динамика записей, отмены и отчеты по филиалам.',
    priceType: 'monthly',
    monthlyPrice: 690,
    icon: 'BarChart3',
    features: ['Загрузка инструкторов', 'Отчеты по филиалам', 'Динамика записей'],
  },
  {
    id: 'roles',
    name: 'Роли и сотрудники',
    category: 'management',
    description: 'Дополнительные пользователи кабинета школы, роли и разграничение доступа.',
    priceType: 'monthly',
    monthlyPrice: 490,
    icon: 'Users',
    features: ['Несколько сотрудников', 'Роли', 'Разграничение доступа'],
  },
  {
    id: 'reminders',
    name: 'Автонапоминания',
    category: 'notifications',
    description: 'Автоматические напоминания ученикам о занятиях через подключенные каналы.',
    priceType: 'monthly',
    monthlyPrice: 390,
    icon: 'Bell',
