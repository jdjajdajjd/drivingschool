  ...
  return (
    <button
      className={cn(
        ...
        {
          primary:
            'border border-forest-700 bg-forest-700 text-white hover:bg-forest-600 hover:border-forest-600 active:bg-forest-800 active:border-forest-800 shadow-soft',
          secondary:
