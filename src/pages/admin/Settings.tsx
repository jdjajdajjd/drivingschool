    ...
    <div className="px-3 pb-24 pt-3 md:px-5 md:pt-4">
      ...
      <div className="space-y-3">
        ...
        <div className="rounded-[14px] border border-[rgba(229,83,75,0.15)] bg-white px-3 py-3">
          ...
          <button onClick={() => setResetOpen(true)} className="mt-2 rounded-[10px] border border-[rgba(229,83,75,0.20)] bg-white px-4 py-2 text-[12px] font-black text-[#E5534B] transition hover:bg-[#FEF2F2]">
      ...
      <ConfirmDialog open={resetOpen} title="Обновить данные" description="Локальный снимок будет очищен и перезагружен." confirmLabel="Обновить" onClose={() => setResetOpen(false)} onConfirm={handleReset} danger />
    </div>
  )
}