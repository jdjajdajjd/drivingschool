...
await check('public_get_student_progress', supabase.rpc('public_get_student_progress', { p_student_id: 'stu-001', p_student_phone: '79161234567' }))
await check('public_get_student_documents', supabase.rpc('public_get_student_documents', { p_student_id: 'stu-001', p_student_phone: '79161234567' }))
