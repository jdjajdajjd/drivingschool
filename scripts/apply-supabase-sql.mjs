...
const safeMigrationPaths = [
  ...
  path.join(rootDir, 'supabase', 'migrations', '012_booking_access_and_overlap_guardrails.sql'),
  path.join(rootDir, 'supabase', 'migrations', '013_schedule_conflicts_and_staff_scope.sql'),
]
